...
def readDetails():
    ...
    deployed_contract_address = '0x05feD14E046Ba944B283414778590880610D8d2A' #hash address to access forensiccontract
...
def saveDataBlockChain(currentData):
    ...
    deployed_contract_address = '0x05feD14E046Ba944B283414778590880610D8d2A'
    with open(compiled_contract_path) as file:
        contract_json = json.load(file)  # load contract info as JSON
        contract_abi = contract_json['abi']  # fetch contract's abi - necessary to call its functions
    file.close()
